...
function ohifInteractorStyleSlice(publicAPI, model) {
    ...
    publicAPI.moveSliceByWheel = (increment)=>{
        ...
        if (slice) {
            ...
            let seriesYear = parseInt(ds.seriesDate.substr(0,4),10);
            let seriesMonth = parseInt(ds.seriesDate.substr(4,2),10);
            let seriesDay = parseInt(ds.seriesDate.substr(6,2),10);
            let sd = new Date(seriesYear, seriesMonth-1, seriesDay);
