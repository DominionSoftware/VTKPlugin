...
function ohifInteractorStyleSlice(publicAPI, model) {
    ...
    publicAPI.moveSliceByWheel = (increment)=>{
        ...
        if (slice) {
            ...
            parent.querySelector("#SliceNumber").innerHTML = "Slice # " + idx;
            parent.querySelector("#Position").innerHTML = "Position " + newPos;
            parent.querySelector("#WorldPosition").innerHTML = " World Position " + worldPos;
            let camPos = renderer.getActiveCamera().getPosition();
            ...
            parent.querySelector("#CameraPosition").innerHTML = "Camera Position " + camPosF;
