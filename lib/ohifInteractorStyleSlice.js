...
function ohifInteractorStyleSlice(publicAPI, model) {
    ...
    publicAPI.moveSliceByWheel = (increment)=>{
        ...
        if (slice) {
            ...
            let patientName = ds.images[0]._study.patientName;
            let vd = publicAPI.getViewDirection();

            let parent = document.querySelector('#'+vd);
            // display is one based.
            const sliceNum = idx + 1;
            parent.querySelector("#SliceNumber").innerHTML = "Slice # " + sliceNum + "/" + idxCount;

            parent.querySelector("#Position").innerHTML = "Position " + newPos;
            parent.querySelector("#PatientName").innerHTML = patientName;
            let viewDirectionString = "";
            switch (vd) {
                case 'A':
            ...
            parent.querySelector("#CameraPosition").innerHTML = viewDirectionString;
            ...
            parent.querySelector("#SlicePosition").innerHTML = "Slice Position " + slicePosF;
