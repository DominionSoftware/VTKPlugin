...
export function getImageData(displaySet,callback,callbackObject) {
    ...
    loadImageDataProgressively(imageIds, imageData, metaDataMap, zAxis,callback,callbackObject);
